...
```
>> **Note** - Actual OID may vary with setup. please use this as reference.
...
```
>> **Note** - Replace OID with output from Task 1.5.2
...
```
**Obervation**
- Does not match with group oid - oid:0x50000000004e9" that was displayed with Task 1.5.2
...
```
**Obervation**
- Matches with group oid - oid:0x50000000004e9" that was displayed with Task 1.5.2
...
gnmic -a 172.20.2.100:8080 --insecure -u admin -p password get --path "/openconfig-system:system/state/software-version"
...
#### Task 4.5.3: Copy Off the Box from the host machine (Optional)
